CREATE DATABASE [restomgmt]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'restomgmt', FILENAME = N'/var/opt/mssql/data/restomgmt.mdf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'restomgmt_log', FILENAME = N'/var/opt/mssql/data/restomgmt_log.ldf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
 WITH LEDGER = OFF
GO
...
GO
ALTER DATABASE [restomgmt] SET AUTO_CREATE_STATISTICS ON(INCREMENTAL = OFF)
GO
...
USE [restomgmt]
GO
IF NOT EXISTS (SELECT name FROM sys.filegroups WHERE is_default=1 AND name = N'PRIMARY') ALTER DATABASE [restomgmt] MODIFY FILEGROUP [PRIMARY] DEFAULT
GO
